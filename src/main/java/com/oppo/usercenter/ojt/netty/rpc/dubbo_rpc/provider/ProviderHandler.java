...
public class ProviderHandler extends SimpleChannelInboundHandler<InvokerProtocol> {

    private Map<String, Object> serviceMapping = new ConcurrentHashMap<>();

    private List<String> classNames = new ArrayList<>();

    public ProviderHandler() throws Exception {
    ...
    protected void channelRead0(ChannelHandlerContext ctx, InvokerProtocol msg) throws Exception {
        Object result = null;
        System.out.println("[request]: [" + JSON.toJSONString(msg) + "]");
