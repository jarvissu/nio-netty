...
public class MethodProxy implements InvocationHandler {
    ...
    public MethodProxy(Class<?> clazz, String registryHost, int registryPort) {
        this.clazz = clazz;
    ...
    private Object rpcInvoke(Object proxy, Method method, Object[] args) throws InterruptedException {
        ...
        /*请求注册中心，获取provider元数据*/
        ConsumerRegistry consumerRegistry = new ConsumerRegistry(this.registryHost, this.registryPort);
        RegisterProtocol providerProtocol = consumerRegistry.request(this.clazz);
        if (Objects.isNull(providerProtocol)) {
        ...
        ChannelFuture channelFuture = bootstrap.connect(providerProtocol.getHost(), providerProtocol.getPort()).sync();
